...
# ----- 1. data acquisition -----
filepath = 'C:/Users/lenovo/Desktop/temperature.csv'
...
# ----- 4. encoding of character type data one-hot -----
# label again the data that is difficult to distinguish
features = pd.get_dummies(features)

# ----- 5. divide eigenvalues and target values -----
...
# ----- 7. build the network model with keras -----
# (1) build layers
# choose style of model
model = tf.keras.Sequential()
# Hidden layer 1 is set to 16 layers, and the weight initialization method is set to random Gaussian distribution
